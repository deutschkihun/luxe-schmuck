    ...
    <>
      <Wrapper>
        ...
        <Message>
          ...
          users purchase luxury products in online enviroment. We do not
          actually sell the items posted in this project. Please note that the
          posted items are data generated as an example. This project allows you
          to register and delete products through an administrator account. You
          can also manage accounts registered with LUXE SCHMUCK. Users can
          search, fill, and get more information as well as order and pay
          through LUXE SCHMUCK.
        </Message>
        <SubmitButton
          style={{ width: "auto" }}
          onClick={() =>
